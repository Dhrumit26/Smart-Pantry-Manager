...
export default function Home() {
  ...
  const backgroundImageUrl = 'https://images.squarespace-cdn.com/content/v1/65e73151adac6d731798857c/5dbddd03-5810-4843-bf19-08d13b3c52c1/panry2.jpg'; // URL for pantry-themed background
      ...
      >
        <Box display="flex" alignItems="center" mb={2} sx={{ textAlign: 'center' }}>
          <Typography 
            ...
            color="#00000"
            sx={{ 
              textShadow: '2px 2px 4px rgba(0, 0, 0, 0.0)', 
              mr: 2 ,
              fontWeight: 'bold'
            }}
          >
            Smart Pantry Mangaer
          </Typography>
